...
#sleep(100);
my @partition = (
'PartitionName=12Cores Nodes=node[08-09] Default=YES MaxTime=INFINITE State=UP DisableRootJobs=NO',
'PartitionName=32Cores Nodes=node[02-07] Default=YES MaxTime=INFINITE State=UP DisableRootJobs=NO',
